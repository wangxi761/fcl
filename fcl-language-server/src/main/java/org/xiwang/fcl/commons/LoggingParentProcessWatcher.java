 ...
 *******************************************************************************/
package org.xiwang.fcl.commons;
 ...
 * PIDs.
 */
public final class LoggingParentProcessWatcher implements Runnable, Function<MessageConsumer, MessageConsumer> {

	private static final Logger LOGGER = Logger.getLogger(LoggingParentProcessWatcher.class.getName());
	...
	private final ParentProcessWatcher.ProcessLanguageServer server;
	private ScheduledFuture<?> task;
	private ScheduledExecutorService service;



	public LoggingParentProcessWatcher(ParentProcessWatcher.ProcessLanguageServer server) {
		this.server = server;
